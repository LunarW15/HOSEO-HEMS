...
namespace HOSEO_HEMS.Views
{
    ...
    public partial class L_Board : ContentPage
    {
        public ObservableCollection<string> LB_Items1 { get; set; }
        public ObservableCollection<string> LB_Items2 { get; set; }
        ...
        public L_Board()
        {
            ...
            LB_Items1 = new ObservableCollection<string>
            {
                subject1,
                subject2,
                subject3,
            ...
            LB_Items2 = new ObservableCollection<string>
            {
                title1,
                title2,
                title3,
            ...
            subject.ItemsSource = LB_Items1;
            title.ItemsSource = LB_Items2;
        }
